...
{	
	...
	$sam = query("select ag_id, ag_unique_id, ag_gender, ag_uname, ag_title, ag_fname, ag_lname, ag_mobile, ag_landline, ag_email, ag_logo, ag_pancard, ag_address, ag_authority, ag_city, ag_country, ag_state, ag_pincode, ag_promotion, cnt_content from ".$tablename." 
