...
<title><? if(!empty($meta_title)){echo $meta_title;}else{echo "SVR Travels India (P) Ltd.";}?></title>
<meta name="keywords" content="<? if(!empty($meta_keywords)){ echo $meta_keywords;}?>">
<meta name="description" content="<? if(!empty($meta_description)){ echo $meta_description;}?>">
...
<link rel='stylesheet' href='css/new_design/bootstrap.css' />
<link rel='stylesheet' href='css/new_design/templatemo_style.css' />
<script>
  (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
  (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),
  m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)
  })(window,document,'script','//www.google-analytics.com/analytics.js','ga');
  ga('create', 'UA-57570467-1', 'auto');
  ga('send', 'pageview');
</script>
...
<div class="header">
	...
	<div class="fr callus mr20">
	<h1><span>Dilsukhnagar : 040-48555509<br />
	<!--9030082829-->Kukatpally : 040-48555089<br/>Warangal  : 9581428289</span></h1><!--<h1>040-6999 8289<br />040-6550 4140</h1>--></div>
...
?>
<script type="text/javascript">(function($){$.fn.list_ticker=function(options){var defaults={speed:4000,effect:'slide'};var options=$.extend(defaults,options);return this.each(function(){var obj=$(this);var list=obj.children();list.not(':first').hide();setInterval(function(){list=obj.children();list.not(':first').hide();var first_li=list.eq(0)
