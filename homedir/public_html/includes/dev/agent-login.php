...
if($_SERVER['REQUEST_METHOD']=="POST")
{
	...
	{
		$query = mysql_query("select ag_id, ag_uname, ag_unique_id, ag_logo, ag_fname, ag_lname, ag_pancard, ag_email, ag_password, ag_address, ag_mobile, ag_deposit, ag_landline, ag_state, ag_country from ".$tablename." where ag_email = '".$_POST['email']."' and ag_password = '".md5($_POST['password'])."' and ag_status = 1");
