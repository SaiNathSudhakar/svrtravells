...
$q = mysql_query("select ord_id,ord_order_id, ord_tmp_id, ord_total_amount, ord_journey_date, ord_added_date, tloc_name from svr_book_order as ord
	left join svr_to_locations as tloc on tloc.tloc_id = ord.ord_tloc_id
		where $cond and ord_status = 1 and ord_request_status = 1 and ord_type = 1");
		
$count = mysql_num_rows($q);

$designFILE="design/fixed-departure-tickets.php";
