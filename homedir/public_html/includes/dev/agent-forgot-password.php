...
{	//echo "select ag_fname, ag_email, ag_password from ".$tablename." where ag_email='".$_POST['email']."'"; exit;
	$yp = mysql_query("select ag_fname, ag_email, ag_password from ".$tablename." where ag_email='".$_POST['email']."'");
	...
	if($yp_cnt!=0) { 
		...
		mysql_query("update ".$tablename." set ag_fg_password='".$random_text."', ag_fg_date='".$now_time."' where ag_email='".$_POST['email']."'");
		...
		$content = "<table width='100%' border='0' align='center' cellpadding='4' cellspacing='0'>		
			...
			<tr>
				...
				<a href='".$site_url."agent-reset-password.php?rid=".$random_text."'>".$site_url."agent-reset-password.php?rid=".$random_text."</a></td>
			</tr>
		</table>";
