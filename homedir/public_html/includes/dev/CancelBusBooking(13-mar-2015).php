...
{	
	...
	if($msg == '') {
		...
		//$makeCancellationRequest = '{"tin":$fetch["ba_ticket_no"],"seatsToCancel":$seats2cancel}';
		$makeCancellationRequest = '{"tin":"'.$fetch["ba_ticket_no"].'","seatsToCancel":'.$seats2cancel.'}';
		//echo $makeCancellationRequest; exit;
