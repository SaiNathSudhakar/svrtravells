...
$result = mysql_query("select ag_fname, ad_id, ad_order_id, ad_ag_id, ad_amount, ad_transaction, ad_bank, ad_drawn, ad_chq_issue_date, ad_dd_no, ad_acc_holder, ad_attach_slip, ad_type, ad_addeddate, ad_req_status, cnt_content from ".$tablename." as ad 
	left join svr_agents as ag on ag.ag_id = ad.ad_ag_id
		left join svr_content_pages on cnt_id = 2
