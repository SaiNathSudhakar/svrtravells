...
$txt_sch_halt = str_replace("'","&#39;",$_POST['txt_sch_halt']);
	...
	{
		mysql_query("update svr_tour_schedule set tloc_id_fk='".$_POST['txt_location']."',sch_day_number='".$_POST['txt_day_no']."',sch_time='".$_POST['txt_sch_time']."',sch_schedule='".$schedule."',sch_halt='".$txt_sch_halt."' where sch_id='".$_GET['sch_id']."'");
		header("location:manage_schedule.php");
	}
	else
	{
		mysql_query("insert into svr_tour_schedule(tloc_id_fk,sch_day_number,sch_time,sch_schedule,sch_halt,sch_status,sch_dateadded) values('".$_POST['txt_location']."','".$_POST['txt_day_no']."','".$_POST['txt_sch_time']."','".$schedule."','".$txt_sch_halt."',1,'".$now_time."')");
		header("location:manage_schedule.php");
...
if(!empty($_GET['sch_id']))
{
 $row = mysql_query("select * from svr_tour_schedule where sch_id='".$_GET['sch_id']."'");
