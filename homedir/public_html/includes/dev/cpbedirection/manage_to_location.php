...
$page_query = mysql_query("select tloc_id from svr_to_locations as tloc
...
$result = mysql_query("select tloc_id, cat_name, subcat_name, subcat_id_fk, tloc_name, tloc_code, tloc_costpp, tloc_image, tloc_ref_no, tloc_international, tloc_orderby, tloc_status from svr_to_locations as tloc
	left join svr_subcategories as subcat on subcat.subcat_id = tloc.subcat_id_fk
		left join svr_categories cat on cat.cat_id = tloc.cat_id_fk
  ...
  <tr>
    <td valign="top" bgcolor="#FFFFFF"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<table width="95%" align="center" border="0" cellspacing="0" cellpadding="6" class="table">
			  ...
			  <td><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="table">
                    <tr>
                      ...
                      <td width="0" align="left" valign="middle"><input name="tit" type="text" class="lstbx2" id="tit" onfocus="this.placeholder='';" onblur="this.placeholder='Search Keyword';" placeholder="Search Keyword" value="<? if(!empty($_SESSION['cat_title_location'])){ echo $_SESSION['cat_title_location'];}?>" size="20"/></td>
		  ...
		  <thead>
		  <tr>
			<td width="2%" height="20" class="tablehead"><strong>S.No</strong></td>
			<td class="tablehead">&nbsp;</td>
			<td class="tablehead">Category &raquo; Sub Category</td>
			<td class="tablehead"><strong style="font-size:12px"> Destination </strong><strong> Location</strong></td>
			<td class="tablehead">Cost PP</td>
			<td class="tablehead">Code</td>
			<td align="center" class="tablehead">Order By</td>
			<td align="center" class="tablehead"><img src="images/view.gif" alt="View" title="View" width="16" height="16" /></td>
			<td align="center" class="tablehead"><img src="images/edit.png" alt="Edit" title="Edit" width="16" height="16" /></td>
			<td align="center" class="tablehead"><img src="images/active.png" alt="Status" title="Status" width="16" height="16" /></td>
		  </tr>
		  </thead>
		  <?php
		  ...
		  <tr class="<? if($sno%2==0) { echo "tablerow2"; } else { echo "tablerow1"; } ?>">
			...
			<?=($fetch['tloc_international'] == 1) ? "<div>&nbsp;&nbsp;&raquo; International</div>" : '';?>
			</td>
