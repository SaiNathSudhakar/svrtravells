...
if(!empty($_GET['f_status']))
{
	...
	mysql_query("update svr_subsubcategories set subsubcat_status=".$status." where subsubcat_id='".$_GET['sid']."'");
...
$page_query = mysql_query("select subsubcat_id from svr_subsubcategories where $cond");
...
$result = mysql_query("select * from svr_subsubcategories where $cond limit $start,$len");
...
if($_SERVER['REQUEST_METHOD']=="POST")
{
	...
	if(!empty($_GET['id'])){
		...
		$update = mysql_query("update svr_subsubcategories set cat_id_fk = '".$_POST['cmb_cat']."',subcat_id_fk='".$_POST['cmb_subcat']."', subsubcat_name='".$_POST['txtlocation']."',subsubcat_thumb_image='".$b_image."' $order_cond where subsubcat_id='".$_GET['id']."'");
		header("location:manage_subsubcategories.php");
	}else{
		mysql_query("insert into svr_subsubcategories(cat_id_fk,subcat_id_fk, subsubcat_name,subsubcat_thumb_image, subsubcat_ref_no, subsubcat_status, subsubcat_dateadded, subsubcat_orderby) 
...
if(!empty($_GET['id']))
{	
	$row = mysql_query("select * from svr_subsubcategories where subsubcat_id = '".$_GET['id']."'");
...
{	
	...
	mysql_query("update svr_subsubcategories set subsubcat_orderby='".$poss2."' where subsubcat_id='".$pos1id."' and cat_id_fk = '".$catid."'");
	mysql_query("update svr_subsubcategories set subsubcat_orderby='".$poss1."' where subsubcat_id='".$pos2id."' and cat_id_fk = '".$catid."'");
	header("location:manage_subcategories.php");
}
?>
                      ...
                      <table width="100%" border="0" align="left" cellpadding="2" cellspacing="1" class="bor_task datatable">
                            ...
                            <tr>
							  ...
							  <option value="">--Select Category--</option>
                                <?php
								  	$svr_query = mysql_query("select cat_id, cat_name from svr_categories where cat_status=1 and cat_id!=1");
