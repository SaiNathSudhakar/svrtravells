                    ...
                    <td valign="top">
                      <table width="100%" border="0" align="left" cellpadding="2" cellspacing="1" class="bor_task datatable">
                            ...
                            <tr>
                              ...
                              <td><input name="date" id="date" type="text" placeholder="Select Calendar" class="jdpicker" value="<? if(!empty($_GET['p_id'])) echo date('d/m/Y',strtotime($package['pkg_date'])); else if(isset($_POST['date'])) echo $_POST['date']; ?>"/></td>
                            </tr>
