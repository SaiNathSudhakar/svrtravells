...
if((isset($_SESSION['tm_type'])) && ($_SESSION['tm_type']=='admin' || ($_SESSION['tm_type']=='subadmin' && isset($_SESSION['packages_manage']) && $_SESSION['packages_manage']=='yes' ) ) ){}else{header("location:welcome.php");}
...
$result = mysql_query("select pkg_id, pkg_status, pkg_date, pkg_seats_available, tloc_name, floc_name, cat_name from svr_packages as pkg
    ...
    <td valign="top" bgcolor="#FFFFFF"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
		  ...
		  <tr>
			...
			<td width="25%" class="tablehead">From Location </td>
			<td class="tablehead">Destination Location </td>
			<td width="15%" class="tablehead"><strong>Package Date </strong></td>
			<td width="15%" class="tablehead">Seats Available</td>
		  ...
		  <tr class="<?=$class;?>" title="<?=$title;?>">
			...
			<td width="5%" align="left"><?=$fetch['cat_name'];?></td>
			<td width="25%" align="left"><?=$fetch['floc_name']; ?></td>
			<td align="left"><?=$fetch['tloc_name']; ?></td>
			<td width="15%" align="left"><?=date('d-m-Y', strtotime($fetch['pkg_date'])); ?></td>
			<td width="15%" align="left"><?=array_sum(explode('|', $fetch['pkg_seats_available']));?></td>
			<td width="5%" align="center"><a href="add_packages.php?p_id=<?=$fetch['pkg_id'];?>">
