...
if(!empty($_GET['id']))
{	
  	$q = mysql_query("select fc_type, fc_name, fc_multiple, fc_adult_child, fc_desc, cat_name, concat(veh.vp_name, ' ', pax.vp_name, ' PAX') as vehicle, group_concat(tloc_name order by tloc_orderby separator ', ') as locations from svr_fare_category as fc
