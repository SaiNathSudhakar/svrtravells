...
$price_cate =str_replace("'","&#39;",$_POST['txt_price_category']);
	if(!empty($_GET['pl_id']))
	{
		mysql_query("update svr_pricelist set tloc_id_fk='".$_POST['sel_destination']."',price_category='".$price_cate."',price_season_one='".$_POST['txt_price_sea_one']."',price_season_two='".$_POST['txt_price_sea_two']."',price_servicetax_season_one='".$_POST['txt_price_service_sea_one']."',price_servicetax_season_two='".$_POST['txt_price_service_sea_two']."',price_convenience_charges__season_one='".$_POST['txt_price_conve_sea_one']."',price_convenience_charges__season_two='".$_POST['txt_price_conve_sea_two']."' where price_id='".$_GET['pl_id']."'");
		header("location:manage_pricelist.php");
	}
	else
	{	
		mysql_query("insert into svr_pricelist(tloc_id_fk,price_category,price_season_one,price_season_two,price_servicetax_season_one,price_servicetax_season_two,price_convenience_charges__season_one,price_convenience_charges__season_two,price_status,price_dateadded) values('".$_POST['sel_destination']."','".$price_cate."','".$_POST['txt_price_sea_one']."','".$_POST['txt_price_sea_two']."','".$_POST['txt_price_service_sea_one']."','".$_POST['txt_price_service_sea_two']."','".$_POST['txt_price_conve_sea_one']."','".$_POST['txt_price_conve_sea_two']."',1,'".$now_time."')");
		header("location:manage_pricelist.php");
	}
}
$edit ="Add";
if(!empty($_GET['pl_id']))
{
  $row = mysql_query("select * from svr_pricelist where price_id='".$_GET['pl_id']."'");
  $schedule = mysql_fetch_array($row);
$edit ="Update";  
}
?>
                      ...
                      <table width="100%" border="0" align="left" cellpadding="2" cellspacing="1" class="bor_task datatable">
                            ...
                            <tr>
                              ...
                              <td align="left"><select name="sel_destination" id="sel_destination">
								...
								<?php
								  	$svr_query = mysql_query("select tloc_id, tloc_name, tloc_type from svr_to_locations where tloc_status=1 order by tloc_orderby");
