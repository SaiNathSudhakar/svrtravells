...
$qur=mysql_query("select * from `svr_gallery` where gal_id='".$_GET['img_id']."'");
  ...
  <tr>
    <td><table width="100%" border="0" align="center" cellpadding="6" cellspacing="1" bgcolor="#E7E7E7" class="curve-border">
      ...
      <tr>
        ...
        <td valign="top" bgcolor="#F3F3F3"><a href="<?=$site_url."uploads/gallery/".$row['gal_upload'];?>" target="_blank"><img src="<?=$site_url."uploads/gallery/".$row['gal_upload'];?>" width="100" height="100"/></a></td>
      </tr>
    </table></td>
  </tr>
  <tr>
