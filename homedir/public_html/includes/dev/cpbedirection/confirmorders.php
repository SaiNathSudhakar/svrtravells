...
if((isset($_SESSION['tm_type'])) && ($_SESSION['tm_type']=='admin' || ($_SESSION['tm_type']=='subadmin' && isset($_SESSION['confirm_orders_manage']) && $_SESSION['confirm_orders_manage']=='yes' ) ) ){}else{header("location:welcome.php");}
$page_query = mysql_query("select book_id from svr_book_details");
$total=mysql_num_rows($page_query);
$len=10; $start=0;
$link="confirmorders.php?a=a";
if(!empty($_GET['start'])) { $start=$_GET['start']; }
	
$result = mysql_query("select * from svr_book_details where book_status=2 order by book_id desc limit $start,$len");
?>
    ...
    <td valign="top" bgcolor="#FFFFFF"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
		  <td><table width="95%" border="0" align="center" cellpadding="2" cellspacing="0">
			<tr>
			  <td valign="middle" width="50%"><img src="images/home-icon.gif" alt="" width="11" height="13" /><strong style="font-size:12px"> <a href="welcome.php">Home</a> &raquo; Manage Confirm Orders</strong></td>
		...
		<tr>
		  ...
		  <tr>
			...
			<td width="36%" class="tablehead">User Details</td>
			<td width="35%" class="tablehead">Package Details</td>
			<td width="12%" align="center" class="tablehead">Order No.</td>
			<td width="10%" align="center" class="tablehead">Seat No.s</td>
		  ...
		  <tr class="<? if($sno%2==0){ echo "tablerow2";} else {echo "tablerow1";}?>">
			...
			<?
			$qur=mysql_query("select pkg_to_id,pkg_date from `svr_packages` where pkg_id=".$fetch['packages_id_fk']);
			...
			<td width="11%" align="center"><?=$fetch['book_orderid'];?></td>
			<td width="11%" align="center"><?=$fetch['book_seat_number'];?></td>
			<td width="3%" align="center"><a href="javascript:;" onClick="window.open('view_orders.php?o_id=<?=$fetch['book_id'];?>','no','scrollbars=yes,menubar=no,width=700,height=600')"><img src="images/view.gif" alt="View" title="View" width="16" height="16" /></a></td>
