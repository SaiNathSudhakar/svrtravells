...
$page_query = mysql_query("select login_id from tm_logindetails");
...
$qur=mysql_query("select * from `tm_logindetails` where 1 ".$cond." order by login_id desc limit $start,$len");
