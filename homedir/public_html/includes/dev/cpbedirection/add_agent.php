...
$edit = "Add";
if(!empty($_GET['e_id'])){
	$result = mysql_query("select * from svr_agents where ag_id='".$_GET['e_id']."'");
                      ...
                      <table width="100%" border="0" align="left" cellpadding="2" cellspacing="1" class="bor_task datatable">
                           ...
                           <tr>
							...
							<tr>
							  ...
							  <? if(!empty($_GET['e_id'])) { $path = $site_url.'agents/'.$fetch['ag_unique_id'].'/'; ?>
