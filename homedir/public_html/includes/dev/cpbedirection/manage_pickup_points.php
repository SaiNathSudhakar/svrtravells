...
{	
	...
	mysql_query("update svr_pickup_points set pick_status=".$status." where pick_id='".$_GET['sid']."'");
	header("location:manage_pickup_points.php");
}
?>
          ...
          <td><table width="95%" border="0" align="center" cellspacing="0" cellpadding="6">
                    ...
                    <tr>
                      ...
                      <td align="left" valign="middle">
					  	<select name="dest_name" id="dest_name" onchange="window.location='manage_pickup_points.php?cat_fltr='+this.value">
                            <? 
							  $dest_q = mysql_query("select tloc_id, tloc_name, tloc_code from svr_to_locations where tloc_status=1 and cat_id_fk = 1 order by tloc_orderby");
              ...
              <tr>
                <td><table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="table">
                    ...
                    <? 
						$q = mysql_query("select tloc_name,pick_id,pick_name,pick_time,pick_status,pick_dateadded from svr_pickup_points left join svr_to_locations as tloc on tloc.tloc_id = svr_pickup_points.tloc_id_fk where 1 order by pick_id desc limit $start,$len");
