...
{	
	...
	$result = mysql_query("select tloc_id, cat_name, subcat_name, subcat_id_fk, tloc_name, tloc_code, tloc_costpp, tloc_orderby, tloc_status from svr_to_locations as tloc
...
/*if(!empty($_GET['moveid']))	{
	if($_GET['move']=="down") {
		$p1=getdata("svr_to_locations","tloc_orderby","tloc_orderby<".$_GET['priority']." order by tloc_orderby desc limit 0,1");
		$p2=getdata("svr_to_locations","tloc_orderby","tloc_id=".$_GET['moveid']);
		$moveid1=$_GET['moveid'];
		$moveid2=getdata("svr_to_locations","tloc_id","tloc_orderby=".$p1."");
		mysql_query("update svr_to_locations set tloc_orderby=".$p1." where tloc_id=".$moveid1);
		mysql_query("update svr_to_locations set tloc_orderby=".$p2." where tloc_id=".$moveid2);
	}
	if($_GET['move']=="up") {
		$p1=getdata("svr_to_locations","tloc_orderby","tloc_orderby>".$_GET['priority']." order by tloc_orderby asc limit 0,1");
		$p2=getdata("svr_to_locations","tloc_orderby","tloc_id=".$_GET['moveid']);
		$nextid=getdata("svr_to_locations","tloc_id","tloc_orderby=".$p1."");
		$moveid1=$_GET['moveid'];
		$moveid2=getdata("svr_to_locations","tloc_id","tloc_id=".$nextid);
		mysql_query("update svr_to_locations set tloc_orderby='".$p1."' where tloc_id=".$moveid1);
		mysql_query("update svr_to_locations set tloc_orderby='".$p2."' where tloc_id=".$moveid2);
	}
}*/
