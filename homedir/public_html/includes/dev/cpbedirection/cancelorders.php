...
$result = mysql_query("select * from svr_book_details where book_status=3 order by book_id desc");

if(!empty($_GET['c_id'])){
	$del = mysql_query("delete from svr_book_details where book_id='".$_GET['c_id']."'");
