		...
		?>
						...
						<? if((isset($_SESSION['tm_type'])) && ($_SESSION['tm_type']=='admin' || ($_SESSION['tm_type']=='subadmin') ) ){?>
                          ...
                          <li class="top"><a href="#nogo" class="top_link"><span class="down">Fares </span></a>
                           ...
                           <? if((isset($_SESSION['tm_type'])) && ($_SESSION['tm_type']=='admin' || ($_SESSION['tm_type']=='subadmin' && isset($_SESSION['fare_cat_add']) && $_SESSION['fare_cat_add']=='yes' && isset($_SESSION['manage_fare_category']) && $_SESSION['manage_fare_category']=='yes' ) ) ){?>
                            <li><a href="manage_fare_category.php" class="fly">Fare Category</a>
							 ...
							 <? if((isset($_SESSION['tm_type'])) && ($_SESSION['tm_type']=='admin' || ($_SESSION['tm_type']=='subadmin' && isset($_SESSION['fare_add']) && $_SESSION['fare_add']=='yes' && isset($_SESSION['manage_fare_category']) && $_SESSION['manage_fares']=='yes' ) ) ){?>
							 <li><a href="manage_fares.php" class="fly">Fares</a>
                                <ul>
                                  <? if((isset($_SESSION['tm_type'])) && ($_SESSION['tm_type']=='admin' || ($_SESSION['tm_type']=='subadmin' && isset($_SESSION['fare_cat_add']) && $_SESSION['fare_add']=='yes' ) ) ){ ?>
                                  <li><a href="add_fares.php">Add Fares</a></li>
                                  <? } if((isset($_SESSION['tm_type'])) && ($_SESSION['tm_type']=='admin' || ($_SESSION['tm_type']=='subadmin' && isset($_SESSION['manage_fare_category']) && $_SESSION['manage_fares']=='yes' ) ) ){ ?>
                          ...
                          <li class="top"><a href="#nogo" class="top_link"><span class="down">Customers</span></a>
                           ...
                           <? if((isset($_SESSION['tm_type'])) && ($_SESSION['tm_type']=='admin' || ($_SESSION['tm_type']=='subadmin' && isset($_SESSION['manage_customers']) && $_SESSION['manage_customers']=='yes' ) ) ){ ?>
							 ...
							 <? if((isset($_SESSION['tm_type'])) && ($_SESSION['tm_type']=='admin' || ($_SESSION['tm_type']=='subadmin' && isset($_SESSION['new_orders_manage']) && $_SESSION['new_orders_manage']=='yes' ) ) ){ ?>
								...
								<? } if((isset($_SESSION['tm_type'])) && ($_SESSION['tm_type']=='admin' || ($_SESSION['tm_type']=='subadmin' && isset($_SESSION['manage_enquiry']) && $_SESSION['manage_enquiry']=='yes' ) ) ){ ?>
			  					<li><a href="manage_enquiries.php">Enquiries</a></li>
						     <? } ?>
						  </ul></li>
						  <? } ?>
                          ...
                          <li class="top"><a href="#nogo" class="top_link"><span class="">Agents</span></a>
                            <ul class="sub">
								<? if((isset($_SESSION['tm_type'])) && ($_SESSION['tm_type']=='admin' || ($_SESSION['tm_type']=='subadmin' && isset($_SESSION['agents_manage']) && $_SESSION['agents_manage']=='yes' ) ) ){ ?>
								  <li><a href="manage_agents.php">Agents</a></li>
								<? } if((isset($_SESSION['tm_type'])) && ($_SESSION['tm_type']=='admin' || ($_SESSION['tm_type']=='subadmin' && isset($_SESSION['agent_deposit']) && $_SESSION['agent_deposit']=='yes' ) ) ){ ?>
								  <li><a href="manage_agent_deposits.php">Deposits</a></li>
								<? } if((isset($_SESSION['tm_type'])) && ($_SESSION['tm_type']=='admin' || ($_SESSION['tm_type']=='subadmin' && isset($_SESSION['agent_book']) && $_SESSION['agent_book']=='yes' ) ) ){ ?>
								  <li><a href="agent_bookings.php">Bookings</a></li>
								<? } if((isset($_SESSION['tm_type'])) && ($_SESSION['tm_type']=='admin' || ($_SESSION['tm_type']=='subadmin' && isset($_SESSION['agent_cancel']) && $_SESSION['agent_cancel']=='yes' ) ) ){ ?>
								  <li><a href="agent_cancellations.php">Cancellations</a></li>
								<? } if((isset($_SESSION['tm_type'])) && ($_SESSION['tm_type']=='admin' || ($_SESSION['tm_type']=='subadmin' && isset($_SESSION['agent_report']) && $_SESSION['agent_report']=='yes' ) ) ){ ?>
						  ...
						  <? if((isset($_SESSION['tm_type'])) && ($_SESSION['tm_type']=='admin' || ($_SESSION['tm_type']=='subadmin' && isset($_SESSION['bus_orders_manage']) && $_SESSION['bus_orders_manage']=='yes' ) ) ){ ?>
