...
$result = mysql_query("select * from svr_customers where $cond order by cust_id desc limit $start,$len");
$count_order=mysql_num_rows($result);

$page_query = mysql_query("select cust_id from svr_customers where $cond");
