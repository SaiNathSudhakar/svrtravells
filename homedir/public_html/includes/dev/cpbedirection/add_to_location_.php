                      ...
                      <table width="100%" border="0" align="left" cellpadding="2" cellspacing="1" class="bor_task datatable">
							...
							<tr>
							  ...
							  <option value="">--Select From Location--</option>
                                <?php
								  	$svr_query = mysql_query("select floc_id, floc_name from svr_from_locations where floc_status=1");
									while($loc=mysql_fetch_array($svr_query)){
                            ...
                            <tr>
                              ...
                              <td align="left">
							  <input type="text" name="nights" id="nights" size="5" value="<?=(!empty($_GET['img_id'])) ? $night : '';?>" /> Nights 
							  <input type="text" name="days" id="days" size="5" value="<?=(!empty($_GET['img_id'])) ? $day : '';?>"/> Days
						  ...
						  <td><!--<div id="sample1">-->
						  Departure <input name="departure" id="departure" value="<?=(!empty($_GET['img_id'])) ? $deptime : '';?>" size="40" /> 						  
                          <!--</div>--></td>
						</tr>
					    <tr>
						      <td valign="top" class="sub_heading_black">&nbsp;</td>
						      <td align="left">Return <input name="return" id="return" value="<?=(!empty($_GET['img_id'])) ? $rettime : '';?>" size="40" /></td>
				        </tr>
					    <?php /*?><tr>
                              <td valign="top" class="sub_heading_black"><strong>Pickup Places</strong></td>
                              <td align="left">
<table width="80%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	<td align="left" valign="top"><? if(empty($_GET['img_id'])) {?>
	<div id="pickup_div">
		<div id="add_pickup_divp">
		  <input type="hidden" name="add_pickup_hiddenp_1" id="add_pickup_hiddenp_1" value="1" />
		  <table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
			  <td width="73%" align="left"><input name="add_pickup1" type="text" class="box" id="add_pickup1" value="" size="60" /></td>
			  <td width="27%" align="left"><input type="hidden" name="add_pickup_counthiddenp" id="add_pickup_counthiddenp" value="1" />
				  <img src="images/add.png" width="16" height="16" border="0" style="cursor:pointer;" onclick="add_pickup_divp()"/></td>
			</tr>
		  </table>
		</div></div>
	  <? } else {?>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
		  <tr>
			<td width="73%" align="left" valign="top"><div id="edit_pickup_divp">
				<?
				$p=1;
				for($pp=0;$pp<=$pickup_count;$pp++){?>
				<div id='edit_pickup_subp_<?=$p;?>'>
				  <input type="hidden" name="edit_pickup_hiddenp_<?=$p;?>" id="edit_pickup_hiddenp_<?=$p;?>" value="1" />
				  <table border="0" cellspacing="0" cellpadding="0">
					<tr>
					  <td align="left"><input name="edit_pickup<?=$p;?>" type="text" class="box" id="edit_pickup<?=$p;?>" value='<?=$edit_pickup[$pp];?>' size="60" /></td>
					  <td align="center">
					  <? if($p>1){?>
					  <img src="images/del.png" alt="Click to Delete" title="Click to Delete" onclick="close_edit_pickup_divp(<?=$p;?>)" width="16" height="16" border="0" style="cursor:pointer;" />
					  <? } else {?><img src="images/add.png" width="16" height="16" border="0" style="cursor:pointer;" onclick="edit_pickup_divp()"/><? } ?></td>
					</tr>
				  </table>
				</div>
			  <? $p++;}?>
...
<input type="hidden" name="edit_pickup_counthiddenp_up" id="edit_pickup_counthiddenp_up" value="<?=$p-1;?>" />
<input type="hidden" name="edit_pickup_counthiddenp" id="edit_pickup_counthiddenp" value="<?=$p;?>" /></td>
		  </tr>
	  </table>
		<script type="text/javascript"> js_pickup_editp=<?=$p-1?>; </script>
		<? }?></td>
  </tr>
</table></td>
                            </tr><?php */?>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
<tr>
  <td width="73%" align="left"><input name="add_cost_includes1" type="text" class="box" id="add_cost_includes1" value="" size="60" /></td>
  ...
  <tr>
	...
	<div id="cost_exc_div">
		<div id="add_ce_divp">
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
			  <td width="73%" align="left"><input name="add_cost_excludes1" type="text" class="box" id="add_cost_excludes1" value="" size="60" /></td>
  ...
  <tr>
	...
	<div id="note_div">
		<div id="add_note_divp">
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
			  <td width="73%" align="left"><input name="add_note1" type="text" class="box" id="add_note1" value="" size="60" /></td>
  ...
  <tr>
	...
	<div id="note2_div">
		<div id="add_note2_divp">
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
			  <td width="73%" align="left"><input name="add_note3" type="text" class="box" id="add_note3" value="" size="60" /></td>
