...
{	
	...
	if(empty($img_err_msg)&& empty($size_err_msg))
	{
		if(!empty($_GET['img_id']))
		{
			...
			mysql_query("insert into svr_settings(`sett_title`,`sett_description`,`sett_status`,`sett_added_date`) values('".$title_replace."','".nl2br($description_replace)."','".$imagepath."',1,'".$now_time."')");
			header("location:manage_settings.php");
		}
	}
}
