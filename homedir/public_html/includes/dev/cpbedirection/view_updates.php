...
<? } if(!is_numeric($_GET['update_id'])){header("location:../index.php");}
$qur=mysql_query("select * from `svr_latest_updates` where up_id='".$_GET['update_id']."'");
...
<table width="98%" border="0" align="center" cellpadding="6" cellspacing="0">
  ...
  <tr>
    <td><table width="100%" border="0" align="center" cellpadding="6" cellspacing="1" bgcolor="#E7E7E7" class="curve-border">
	  <tr>
		  <td width="25%" valign="top" bgcolor="#F3F3F3"><strong>Title</strong></td>
		  <td width="75%" valign="top" bgcolor="#F3F3F3"><?=$row['up_title'];?></td>
	  </tr>  
	  <? if($row['up_desc'] != ''){?>
	  <tr>
      ...
      <tr>
          <td colspan="2" valign="top" bgcolor="#F3F3F3"><div align="justify"><?=$row['up_desc'];?></div></td>
      </tr>
	  <? }?>
    </table></td>
  </tr>
