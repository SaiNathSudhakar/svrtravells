          ...
          <td><table width="95%" align="center" border="0" cellspacing="0" cellpadding="6">
              ...
              <tr>
                <td><table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="table">
					...
					mysql_query("update svr_pricelist set price_status=".$status." where price_id='".$_GET['pl_id']."'");
					...
					<?
					$result = mysql_query("select * from svr_pricelist where tloc_id_fk=".$qry_arr['tloc_id']);
