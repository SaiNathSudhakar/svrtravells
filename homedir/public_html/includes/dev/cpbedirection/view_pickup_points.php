...
$qur=mysql_query("select tloc_name,pick_name, pick_time, pick_note from `svr_pickup_points` left join svr_to_locations as tloc on tloc.tloc_id = svr_pickup_points.tloc_id_fk where pick_id='".$_GET['p_id']."'");
