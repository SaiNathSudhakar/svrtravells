...
$qur=mysql_query("select * from `svr_agents` where ag_id='".$_GET['e_id']."'");
...
<table width="75%" border="0" align="center" cellpadding="6" cellspacing="0">
  ...
  <tr>
	...
	<tr>
        <td bgcolor="#F3F3F3" colspan="2" align="center"><img src="<?=$site_url.'uploads/agents/'.$row['ag_unique_id'].'/'.$row['ag_logo'];?>" /></td>
      </tr>
	  <? }?>
	  <tr>
