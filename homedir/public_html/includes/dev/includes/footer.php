...
if($_SERVER['REQUEST_METHOD']=="POST")
{
	...
	{
		$qur=mysql_query("select count(nl_email) as eml_cnt from svr_nl where nl_email='".$_POST['txt_nl_email']."'");
...
<div id="footerwrap">
	<div class="footer">
		<div class="copyright">
			<span class="fl" style="margin:0px 0 0 0">Copyright &copy 2014 SVR Travels India (P) Ltd. All Rights Reserverd.</span>
