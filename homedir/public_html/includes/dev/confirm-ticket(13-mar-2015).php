...
{	
	...
	{	
		...
		//Update Agent Amount
		//mysql_query("update svr_agents set ag_deposit = (ag_deposit-".$fetch['ba_total_fare'].") where ag_id = '".$_SESSION[$svra.'ag_id']."'");
	...
	$data['content'] .= "<tr>
	  ...
	  <tr>
		...
		<td align='center'><strong>:</strong></td>
		<td align='left'>".$row['ba_travels_name']." ".$fetch['ba_travels_type']."</td>
	  </tr>
	  <tr>
	...
	$row = mysql_fetch_array($q); $num = mysql_num_rows($q); if($num <= 0) header('location:BusBooking.php');
	$booking_date = ($row['ba_updateddate'] != '0000-00-00 00:00:00' && $row['ba_updateddate'] != '1970-01-01 05:00:00') ? $row['ba_updateddate'] : $row['ba_addeddate'];
