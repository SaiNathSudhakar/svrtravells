...
<table width="100%" border="0" cellpadding="5" cellspacing="1" bordercolor="#F2F2F2">
  <thead>
	  ...
	  <th align="left" width="20%">Type/Refund</th>
	  <th align="left" width="15%">Journey / Cancellation</th>
  	</tr>
  </thead>
  <tbody>
	  ...
	  <td><?=date('d-M-Y', strtotime($fetch['ord_journey_date']));?><br>
	  <?=date('d-M-Y', strtotime($fetch['ord_cancel_date']));?></td>
	</tr>
  	<? } } if($count == 0) { ?>
