...
$(document).ready(function() {
	...
	$('#tabOverInput').
	  click( function(e) { $(this).off('click').AnyTime_picker({format: "%M %D, %Y", earliest: new Date(1950,0,1,0,0,0), latest: new Date(2005,11,31,23,59,59)}).focus(); } ).
	  keydown(
		function(e) { 
...
function validation()
{
	...
	if(!validEmail(d.conemail.value)){ alert("Please Valid E-Mail Address Again"); d.conemail.value=""; d.conemail.focus(); return false; }
