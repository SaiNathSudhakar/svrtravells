...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	<td align="left" valign="top">
		<div class="fl mr20"><input name="" type="radio" value="" checked="checked" /> One Way</div>
  ...
  <tr>
	<td align="left" valign="top" height="55">
		<div class="fl mr20 orange" style="line-height:25px;">Departure Date<br /><input name="" type="text" value="dd-mm-yy" style="width:80px;"/><img src="images/calendar.png" class="ml5" alt="calendar icon" height="16" width="16" /></div>
		<div class="fl orange" style="line-height:25px;">Return Date<br /><input name="" type="text" value="dd-mm-yy" style="width:80px;"/><img src="images/calendar.png" class="ml5" alt="calendar icon" height="16" width="16" /></div>
	</td>
  </tr>
  <tr>
...
<form name="fixed_departures" id="fixed_departures" method="post" action="">
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		<td height="55" colspan="2" align="left" valign="top">
		<div class="fl orange" style="line-height:25px; font-size:16px">
			<img src="images/marker.png" class="fl mr15" height="24" width="18" alt="marker" />
		...
		<select name="fdfromloc" id="fdfromloc" style="width:180px;">
			...
			<?  $svr_query = query("select distinct(floc_id), floc_name from `svr_to_locations` as tloc
	...
	<tr>
		<td height="55" colspan="2" align="left" valign="top">
		  <div class="fl orange" style="line-height:25px; font-size:16px">
			<img src="images/marker.png" class="fl mr15" height="24" width="18" alt="marker" />I want to go to<br />
	...
	<tr>
		...
		<div class="fl orange" style="line-height:25px; font-size:16px">
			<img src="images/watch.png" height="19" width="19" class="fl mr15 mt10" alt="watch" />
			...
			<input type="text" class="input2" id="datepicker1" name="datepicker1" size="20" maxlength="100" value="<?=$date?>" readonly="readonly" />
		</div></td>
	</tr>
	<tr>
...
<form name="holiday_package" id="holiday_package" method="post" action="">
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		<td height="55" colspan="2" align="left" valign="top">
		<div class="fl orange" style="line-height:25px; font-size:16px">
			<img src="images/marker.png" height="24" width="18" class="fl mr15" alt="marker" />
			<span style="display:block; border-bottom: solid 1px #8486ba; float:left; width:180px">I'm here</span>
		</div>
	...
	<tr>
		<td height="55" colspan="2" align="left" valign="top">
		  <div class="fl orange" style="line-height:25px; font-size:16px">
			<img src="images/marker.png" height="24" width="18" class="fl mr15" alt="marker" />I want to go to<br />
	...
	<tr>
		...
		<div class="fl orange" style="line-height:25px; font-size:16px">
			...
			<input type="text" class="input2" id="datepicker2" name="datepicker2" size="20" maxlength="100" readonly="readonly" value="<?=$date?>" />
		</div></td>
	</tr>
	<tr>
		<!--<td valign="top" align="right" id="seat_avail_div">&nbsp;</td>-->
...
<?  $url = substr(strtolower(basename($_SERVER['PHP_SELF'])),0,strlen(basename($_SERVER['PHP_SELF']))-4);
	if($url != 'index') {?>
<div class="fr" style="width:78%; padding-top: 8px;">
	<div id='calendar'></div>
	<div class="clear"></div>
</div>
<? }?>
...
$(document).ready(function() {
    $('#calendar').fullCalendar({
		<? if(!empty($_GET['date'])){?>defaultDate: moment('<?=date('Y-m-d', strtotime($_GET['date']));?>'),<? }?>
        header: { left: 'prev,next today', center: 'title', right: '' },
        events: [ <? foreach($avail_seats as $date => $seats){ ?>{ title: '( <? if($seats==0) echo "Sold Out"; else echo $seats." Vacant";?>  )', url: 'fixed-departure-booking.php?lid=<?=$lid?>&date=<?=date('d-m-Y', strtotime($date));?>', color  : '<? if($seats==0) echo "#e40011"; else echo "#008000";?> !important', start: '<?=$date;?>'},<? }?>]


    });
	//$('#calendar').fullCalendar('gotoDate', <?=date('Y-m-d', strtotime($_GET['date']));?>);
});
</script>
