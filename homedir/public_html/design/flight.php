...
<? if(empty($_GET['st'])){ ?>
	...
	<div id="error"></div>
	<form name="flight_form" id="flight_form" method="post">
		<div class="form_styles form_wrapper">
	
		<div class="clear" style="line-height:5px">&nbsp;</div>
		<input name="from_date" type="text" id="tabOverInput1" class="tabOverInput" placeholder="From Date *" autocomplete="off">
		<input name="to_date" type="text" id="tabOverInput2" class="tabOverInput" placeholder="To Date *" autocomplete="off">
