...
<div class="myprofile">
<div class="fl"><h1>My Tour Package Orders</h1></div>
...
<table width="100%" border="0" cellpadding="5" cellspacing="1" bordercolor="#F2F2F2">
  ...
  <tbody>
	  ...
	  <a href="javascript:;" onclick="cancel_ticket('<?=$fetch['ord_tmp_id'];?>', '<?=$fetch['ord_total_amount']?>', '<?=$fetch['ord_order_id'];?>');" class="flinks1">Cancel</a>
	  <? }?>
	  </td>
  	</tr>
  	<? }} else{?>
...
function cancel_ticket(id,amt,oid)
{	
