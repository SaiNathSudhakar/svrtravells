		  ...
		  <table style="border:1px solid #eaeaea;" cellpadding="10" cellspacing="1" width="100%">
			<tbody>
			  ...
			  <tr bgcolor="<?=($i % 2 == 0) ? '#FFFFFF' : '#F4F4F4';?>">
                ...
                <input type="hidden" name="fare<?=$i.$j;?>" id="fare<?=$i.$j;?>" value="<?=$fixed_fares[$fare_cat['fc_id']][$ac];?>">
				<span class="rupee">&#x20B9;</span> <?=$fixed_fares[$fare_cat['fc_id']][$ac].'/-';?></td>
				<? $j++; }?>
				<td align="center" valign="middle" nowrap="nowrap">
			  ...
			  <tr>
			    ...
			    <td align="center" valign="middle"><div id="total_amount">0</div>
				<input type="hidden" name="ag_dp" id="ag_dp" data-num="<?=(!empty($_SESSION[$svra.'ag_deposit'])) ? '1' : '';?>" value="<?=(!empty($_SESSION[$svra.'ag_deposit'])) ? $_SESSION[$svra.'ag_deposit'] : '';?>" />
				</td>
			  </tr>
			</tbody>
		  </table>
