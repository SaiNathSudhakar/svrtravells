...
{	
	...
	{	
		query("update svr_book_order_temp set bot_request_status = 1 where bot_order_id = '".$_GET['order_id']."'");
		...
		//Update Agent Amount
		//query("update svr_agents set ag_deposit = (ag_deposit-".$bill.") where ag_id = '".$_SESSION[$svra.'ag_id']."'");
		...
		//Update Agent Report
		query("insert into svr_agent_reports (ar_id, ar_ag_id, ar_ref_id, ar_ord_id, ar_ad_id, ar_transaction_type, ar_opening_bal, ar_amount, ar_commission, ar_net_amount, ar_closing_bal, ar_cre_deb, ar_fk_id, ar_date_time) values( '', '".$_SESSION[$svra.'ag_id']."', '".$ref_id."', '".$_GET['order_id']."', '', '".$transc."', '".$op_bal."', '".$bill."', '".$comm."', '".$net."', '".$cl_bal."', '1', '".$fkid."', '".$now_time."')");
 ...
 $qur=query("select ord_journey_date, ord_return_date, cat_name, floc_name, floc_id, ord_id, ord_order_id, ord_journey_date, ord_return_date, ord_pkg_id, ord_amount, ord_type, ord_acc_type, ord_room_type, ord_vehicle_type, ord_fc_qty, ord_tot_adult, ord_tot_child, ord_no_of_persons, ord_seat_number, ord_pickup_from, ord_pickup_place, ord_pickup_place_detail, ord_pickup_time, ord_drop_at, ord_drop_place, ord_drop_place_detail, ord_drop_time, ord_emergency_number, ord_comments, ord_total_amount, ord_request_status, tloc_name, tloc_code, tloc_room_type, tloc_type, cust_fname, cust_lname, cust_email, cust_mobile, cust_address_1, cust_address_2, cust_city, cust_state, cust_country, cust_pincode, group_concat(fc.fc_id) as fc_ids, ord_fc_qty as fc_qtys, veh.vp_name as vehicle from svr_book_order as ord
