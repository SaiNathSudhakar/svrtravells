...
{	
	...
	$q = query("select ba_unique_id, ba_source_name, ba_destination_name, ba_ticket_no, ba_total_fare, ba_trip_id, ba_order_status, ba_ticket_no, ba_journey_date, ba_boarding_time, ba_no_passenger, ba_seat_no, ba_travels_name, ba_travels_type, ba_boarding_location, ba_boarding_time, ba_email, ba_mobile, ba_updateddate, ba_addeddate from svr_api_orders_temp where ba_id='".$_GET['orderid']."'");
	$fetch = fetch_array($q);
...
<div style="text-align:center; padding-bottom:10px;"><span class="ml10 mb20"><input type="button" class="btn" onclick="printDiv('inner_content')" value="Print"></span></div>
<?  }?>
