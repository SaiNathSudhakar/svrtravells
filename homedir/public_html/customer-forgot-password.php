...
{	
	$yp = query("select cust_fname, cust_email, cust_password from ".$tablename." where cust_email='".$_POST['email']."'");
	$yp_cnt = num_rows($yp);
	...
	if($yp_cnt!=0) { 
		...
		query("update ".$tablename." set cust_fg_password='".$random_text."', cust_fg_date='".$now_time."' where cust_email='".$_POST['email']."'");
		...
		$content = "<table width='100%' border='0' align='center' cellpadding='4' cellspacing='0'>			
			...
			<tr>
				...
				<a href='"."customer-reset-password.php?rid=".$random_text."'>"."customer-reset-password.php?rid=".$random_text."</a></td>
			</tr>
		</table>";
