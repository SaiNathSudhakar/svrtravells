...
$q = query("select cat_name, ord_id, ord_order_id, ord_tmp_id, ord_amount, ord_total_amount, ord_journey_date, ord_added_date, ord_ag_id, tloc_name from svr_book_order as ord
	left join svr_to_locations as tloc on tloc.tloc_id = ord.ord_tloc_id
		left join svr_categories as cat on cat.cat_id = ord.ord_type
