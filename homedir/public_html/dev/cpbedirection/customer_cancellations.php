			  ...
			  <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="table">
                    <tr>
					  ...
					  <? if($_SESSION['cb_search'] != ''){ ?>
                          <img src="images/reset.png" onclick="javascript:window.location='customer_cancellations.php?src=reset'" align="absmiddle" style="cursor:pointer;" value="Reset" title="Reset"/>   
                        <? } ?></td>
                    </tr>
                </table>
			  </td>
