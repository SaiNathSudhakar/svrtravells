...
if($_SERVER['REQUEST_METHOD']=="POST")
{
	...
	{
		query("update `svr_subcategories` set `subcat_meta_title`='".addslashes($_POST['meta_title'])."',`subcat_meta_description`='".addslashes($_POST['meta_description'])."',`subcat_meta_keywords`='".addslashes($_POST['meta_keywords'])."' where subcat_id='".$_GET['meta_id']."'");
		$uri=(!empty($_GET['start']))? "start=".$_GET['start']."&":'';
		header("location:manage_subcat_keywords.php?".$uri."msg=up");
	}
}
if(!empty($_GET['meta_id']))
{
	$qur_de="select subcat_name, subcat_meta_title, subcat_meta_description, subcat_meta_keywords from `svr_subcategories` where subcat_id=".$_GET['meta_id']." ";
	$res_de=query($qur_de);
...
<form action="" method="post" name="form1" id="form1" onsubmit="return chk_valid()" enctype="multipart/form-data">
			    <table width="75%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="right" valign="top"><a href="manage_subcat_keywords.php"><strong>Manage Subcategories Keywords</strong></a></td>
                  </tr>
                  <tr>
                    <td valign="top">&nbsp;</td>
                  </tr>
                ...
                <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="bor_task datatable">
              	...
              	<tr class="form_table_row1">
              	  ...
              	  <td align="left"><?=$row_de['subcat_name'];?></td>
            	  </tr>
              	<tr class="form_table_row1">
                <td width="4%" align="left">&nbsp;</td>
                <td width="16%" align="left">Meta Title</td>
                <td width="80%" align="left"><input type="text" class="input" size="80" name="meta_title" id="meta_title" value="<? if(!empty($_POST['meta_title'])){ echo $_POST['meta_title'];} else if(!empty($_GET['meta_id'])){ echo $row_de['subcat_meta_title']; }?>" /></td>
              </tr>
			  <tr class="form_table_row1">
                <td width="4%" align="left">&nbsp;</td>
                <td width="16%" align="left">Meta Description</td>
                <td width="80%" align="left"><textarea name="meta_description" id="meta_description" rows="5" cols="61"><? if(!empty($_GET['meta_id'])){ echo $row_de['subcat_meta_description'];}?>
                </textarea></td>
              </tr>
			  <tr class="form_table_row1">
                <td width="4%" align="left">&nbsp;</td>
                <td width="16%" align="left">Meta Keywords</td>
                <td width="80%" align="left"><input type="text" class="input" size="80" name="meta_keywords" id="meta_keywords" value="<? if(!empty($_GET['meta_id'])){ echo $row_de['subcat_meta_keywords'];}?>" /></td>
              </tr>
