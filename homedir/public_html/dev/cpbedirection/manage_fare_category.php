...
query("update svr_fare_category set fc_status=".$status." where fc_id='".$_GET['f_id']."'");
header("location:manage_fare_category.php");
}
$page_query = query("select fc_id from svr_fare_category");
...
$result = query("select fc_id, fc_type, fc_locations, fc_name, fc_orderby, fc_status, fc_dateadded, cat_id, cat_name, group_concat(tloc_name order by tloc_orderby) as to_locations, concat(veh.vp_name, ' ', pax.vp_title, ' PAX') as vehicle from svr_fare_category as fc 
...
{	
	...
	query("update svr_fare_category set fc_orderby='".$poss2."' where fc_id='".$pos1id."'");
	query("update svr_fare_category set fc_orderby='".$poss1."' where fc_id='".$pos2id."'");
	header("location:manage_fare_category.php");
}
?>
