...
$qur=query("select tloc_name, tloc_meta_title, tloc_meta_description, tloc_meta_keywords from `svr_to_locations` where tloc_id='".$_GET['key_id']."'");
$row=fetch_array($qur);
?>
<style type="text/css">
<!--
...
<table width="98%" border="0" align="center" cellpadding="6" cellspacing="0">
  ...
  <tr>
      ...
      <tr>
        <td width="25%" valign="top" bgcolor="#F3F3F3"><strong>Meta Title</strong></td>
        <td valign="top" bgcolor="#F3F3F3"><?=$row['tloc_meta_title'];?></td>
      </tr>
      ...
      <tr>
        <td colspan="2" valign="top" bgcolor="#F3F3F3"><?=$row['tloc_meta_description'];?></td>
      </tr>

      <tr>
        <td valign="top" bgcolor="#F3F3F3"><strong>Meta Keywords</strong></td>
        <td valign="top" bgcolor="#F3F3F3"><?=$row['tloc_meta_keywords'];?></td>
      </tr>
