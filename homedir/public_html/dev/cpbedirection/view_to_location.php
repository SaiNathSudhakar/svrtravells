...
$qur=query("select tloc_id, cat_name, subcat_name, subsubcat_name, tloc_name, tloc_code, tloc_costpp, tloc_transport, tloc_time, tloc_type, tloc_cost_includes, tloc_cost_excludes, tloc_code, tloc_pickup_point, tloc_places_covered, tloc_ref_no, tloc_image, tloc_notes, tloc_orderby, tloc_status from svr_to_locations as tloc
  ...
  <tr>
    <td><table width="100%" border="0" align="center" cellpadding="6" cellspacing="1" bgcolor="#E7E7E7" class="curve-border">
      ...
      <tr>
		...
		<? $path = "../uploads/destination_locations/".$row['tloc_ref_no']."/"; ?>
      ...
      <? } //$sno=0; while($row=fetch_array($qur)){$sno++; ?>
	 <?php /*?> <tr>
