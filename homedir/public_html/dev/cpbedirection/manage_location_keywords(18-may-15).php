...
$page_query = mysql_query("select tloc_id from svr_to_locations");
$total=mysql_num_rows($page_query);
$len=10; $start=0;
$link="manage_location_keywords.php?a=a";
...
$result = mysql_query("select tloc_id, tloc_name, tloc_meta_title  from svr_to_locations where 1 order by tloc_id desc limit $start,$len");
    ...
    <td valign="top" bgcolor="#FFFFFF"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
		  <td><table width="95%" border="0" align="center" cellpadding="2" cellspacing="0">
			<tr>
			  <td valign="middle" width="50%"><img src="images/home-icon.gif" alt="" width="11" height="13" /><strong style="font-size:12px"> <a href="welcome.php">Home</a> &raquo; Manage Location Keywords</strong></td>
		...
		<tr>
		  <td valign="top"><table width="95%" border="0" align="center" cellpadding="6" cellspacing="0">
            <tr>
              <td align="left"><h1>Location Keywords</h1></td>
            </tr>
            <tr>
		...
		while($fetch=mysql_fetch_array($result))
			...
			?>
                <tr class="<? if($sno%2==0){ echo "tablerow2";} else {echo "tablerow1";}?>">
                  ...
                  <td align="left"><a href="../destination-details.php?lid=<?=$fetch['tloc_id'];?>" target="_blank"><?=$fetch['tloc_name'];?></a></td>
				  <td align="left"><?=$fetch['tloc_meta_title'];?></td>
                  <td width="5%" align="center"><a href="javascript:;" onclick="popupwindow('view_location_keywords.php?key_id=<?=$fetch['tloc_id'];?>','','650','450')"><img src="images/view.gif" alt="View" title="View" width="16" height="16" /></a></td>
                  <td width="5%" align="center"><a href="add_location_keywords.php?meta_id=<?=$fetch['tloc_id'];?>"><img src="images/edit.png" alt="Edit" title="Edit" width="16" height="16" /></a></td>
                </tr>
                <?
			}
		}
