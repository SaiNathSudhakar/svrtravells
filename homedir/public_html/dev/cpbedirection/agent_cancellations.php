...
if(!empty($_SESSION['cb_agent']))
{ 	
	$cond .= " and ag_id = '".$_SESSION['cb_agent']."'";
}
		    ...
		    <tr>
		      <td><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="table">
                    <tr>
					  ...
					  <? if(isset($_SESSION['cb_search']) || isset($_SESSION['cb_agent'])){ ?>
                          <img src="images/refresh.png" onclick="javascript:window.location='agent_cancellations.php?src=reset'" style="cursor:pointer;" height="24" width="24" value="Reset" title="Reset"/>   
                        <? } ?></td>
                    </tr>
                </table></td>
		      </tr>
