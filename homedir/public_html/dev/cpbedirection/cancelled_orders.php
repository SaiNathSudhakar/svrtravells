...
<script language="javascript" src="../js/script.js"></script></head></head>
<body>
			  ...
			  <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="table">
                    <tr>
					  ...
					  <? if(isset($_SESSION['cb_search'])){ ?>
                          <img src="images/refresh.png" onclick="javascript:window.location='cancelled_orders.php?src=reset'" style="cursor:pointer;" height="24" width="24" value="Reset" title="Reset"/>   
                        <? } ?></td>
                    </tr>
                </table>
			  </td>
