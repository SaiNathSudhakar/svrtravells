...
{	
	...
	$query = query("select adt_amount, adt_order_id, adt_type, ag_fname, ag_gender, ag_lname, ag_address, ag_email, ag_mobile, ag_city, ag_state, ag_country, ag_pincode from svr_agent_deposits_temp as adt
	...
	$success_url = 'agent-payment-status.php?status=1&order_id='.$row['adt_order_id'];
	$failure_url = 'agent-payment-status.php?status=2&order_id='.$row['adt_order_id'];
} ?>
<body onLoad="check();">
    <!--<h2>PayU Form</h2>-->
    <br/>
