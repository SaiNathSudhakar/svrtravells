...
$yp = query("select ag_id from ".$tablename." where ag_fg_password ='".$_GET['rid']."'");
$yp_cnt = num_rows($yp);
...
if($_SERVER['REQUEST_METHOD']=="POST")
{
	...
	if(!empty($_POST['reset_password']) || $yp_fetch['ag_id']==$_GET['rid']){
		query("update ".$tablename." set ag_password ='".md5($_POST['new_pwd'])."' where ag_fg_password='".$_GET['rid']."'");
