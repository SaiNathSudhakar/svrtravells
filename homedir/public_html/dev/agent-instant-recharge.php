...
if($_SERVER['REQUEST_METHOD']=="POST")
{
	...
	query("insert into svr_agent_deposits_temp(adt_id, adt_order_id, adt_ag_id, adt_amount, adt_mobile, adt_type, adt_status, adt_addeddate)values('','".$_SESSION[$svra.'ag_order_id']."','".$_SESSION[$svra.'ag_id']."','".$amount."','".$_SESSION[$svra.'ag_mobile']."',4,1,'".$now_time."')");
	
	//P A Y M E N T   G A T E W A Y
	header("location:agent-payment.php?order_id=".$_SESSION[$svra.'ag_order_id']);
}

$sam = query("select adt_id, adt_ag_id, adt_amount, adt_mobile, adt_type, cnt_content from ".$tablename." 
