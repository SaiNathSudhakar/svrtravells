...
if($_SERVER['REQUEST_METHOD']=="POST")
{
	...
	{
		$query = query("select cust_id, cust_title, cust_fname, cust_lname, cust_email, cust_address_1, cust_mobile, cust_landline, cust_state, cust_country from ".$tablename." where cust_email = '".$_POST['email']."' and cust_password = '".md5($_POST['password'])."'");
...
$meta_title ="Customer Login | Tour Packages For South India SVR Travels";
$meta_keywords ="online bus booking, online flight booking, online travel booking, cheap holiday packages in india, international trip packages";
$meta_description ="Andaman & lakshadweep Packages, philgrimage tours, Honeymoon packages, STUDENT EDUCATION TOURS, international tour operators, india tour packages with prices";
