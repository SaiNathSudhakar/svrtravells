<?php
	...
	$key = "HiVGXQ3DMMO919OOcRdhkDIAgL69Li"; 
	$secret = "qsAl0ycccZY28Z0VNlN1D8DmIU9N4T";
	...
	function checkBookedTicket($blockKey)
	{
		return invokePostRequest("checkBookedTicket?blockKey=".$blockKey);
	}
	
	/*function getTicketInformation($ticket)
	{
		return invokeGetRequest("ticket?tin=".$ticket);
	}*/
?>