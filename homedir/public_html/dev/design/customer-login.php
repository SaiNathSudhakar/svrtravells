...
<div class="navigation">
	<div class="bg"><a href="index.php">Home</a><span class="divied"></span><span class="pagename">Customer Login</span></div>
</div>
...
<form name="customer_login_form" id="customer_login_form" method="post">
	...
	<input name="password" type="password" id="password" maxlength="12" placeholder="Password">
   	<div class="clear" style="line-height:5px">&nbsp;</div>
	<input name="login" type="hidden" value="cust_login">
...
function validation(){
//alert('kkkk');
	var d=document.customer_login_form;
