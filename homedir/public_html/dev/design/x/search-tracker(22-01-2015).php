...
<div id="tabs">
	<div class="tab_ac" id="mdiv1" onClick="tab('div1')" style="line-height:34px; padding:0 8px;">Flights</div>
	<div class="tab_ac fl" id="mdiv2" onClick="tab('div2')" style="line-height:34px; padding:0 8px;">Bus</div>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	<td align="left" valign="top">
		<div class="fl mr20"><input name="a" type="radio" value="" checked /> One Way</div>
		<div class="fl mr20"><input name="a" type="radio" value="" />Return</div>
	</td>
  </tr>
  <tr>
	<td height="45" align="left" valign="top">
		<div class="fl mr40 orange" style="line-height:25px;">Leaving from<br /><input name="" type="text" value="city" style="width:85px;"/></div>
		<div class="fl orange" style="line-height:25px;">Going to<br /><input name="" type="text" value="city" style="width:85px;"/></div>
	</td>
  </tr>
  <tr>
	<td align="left" valign="top" height="55">
		<div class="fl mr20 orange" style="line-height:25px;">Departure Date<br /><input name="" type="text" value="dd-mm-yy" style="width:80px;"/><img src="images/calendar.png" class="ml5" id="datepicker-example8" /></div>
		<div class="fl orange" style="line-height:25px;">Return Date<br /><input name="" type="text" value="dd-mm-yy" style="width:80px;"/><img src="images/calendar.png" class="ml5" id="datepicker-example8" /></div>
	</td>
  </tr>
  <tr>
...
<tr>
	<td align="left" valign="top">
		<div class="fl mr20"><input name="b" type="radio" value="" checked />One Way</div>
		<div class="fl mr20"><input name="b" type="radio" value="" />Round Trip</div>
	</td>
</tr>
<tr>
	<td height="55" align="left" valign="top">
		<div class="fl orange" style="line-height:25px;">From<br /><input name="" type="text" value="city" style="width:200px;"/></div>
	</td>
</tr>
<tr>
	<td height="55" align="left" valign="top">
		<div class="fl  orange" style="line-height:25px;">To<br /><input name="" type="text" value="city" style="width:200px;"/></div>
	</td>
</tr>
<tr>
<td align="left" valign="top" height="65">
	<div class="fl mr20 orange" style="line-height:25px;">Date of Journey<br />
		<input name="" type="text" value="dd-mm-yy" style="width:150px;"/>
		<img src="images/calendar.png" class="ml5" id="datepicker-example8" />
	</div>
</td>
</tr>
<tr>
	<td valign="top" align="center"><input name="" type="button" class="submit-btn" value="Book Now" /></td>
</tr>
</table>
<div class="clear"></div>   
</div>
	...
	$(document).ready(function() {
		...
		$('#calendar').fullCalendar({
			...
			events: [
				...
				<? foreach($avail_seats as $date => $seats){ ?>
				{
					title: '( <?=$seats;?> Vacant )',
					url: 'fixed-departure-booking.php?lid=<?=$lid?>&date=<?=date('d-m-Y', strtotime($date));?>',
					start: '<?=$date;?>'
				},
				<? }?>
			]
