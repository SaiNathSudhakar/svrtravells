...
if($count_order>0){
	$sno=$start;
	while($fetch=fetch_array($result)){ $sno++;
?>
<tr>
	<td><?=$sno;?>.</td>
	...
	<td nowrap="nowrap"><?=$ag_dep_req_status[$fetch['ad_req_status']];?></td>
	...
	<?php /*?><td><a href="view-agent-history.php?dep_id=<?=$fetch['ad_id']?>"></a></td><?php */?>
	<td><a href="view-agent-history.php?dep_id=<?=$fetch['ad_id']?>" class="various" data-fancybox-type="iframe" >
	<img src="images/view.gif" alt="View" title="View" width="16" height="16" /></a></td>
</tr>
...
<? if($total>$len){ ?>
<tr>
  <td colspan="13"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	  <tr>
