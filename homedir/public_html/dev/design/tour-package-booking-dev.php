...
<p>&nbsp;</p><h3>Hotel Fare Per Night in INR (<span class="rupee bold red">&#x20B9;</span>)</h3>
	<? hotel_fares_table($hfare_cats, $hfarecatnames, $hacc, $hotel_fares);
}?>
<div class="clear"></div>
<br />
...
<table width="100%" border="0" cellpadding="5" cellspacing="1" bordercolor="#F2F2F2">
  ...
  <tr>
    <td align="left" valign="middle">Hotel Name<span class="star">*</span></td>
    <td align="center" valign="middle">:</td>
    <td align="left" valign="middle" id="hotel_div">
    <select name="hotel" id="hotel" class="list">
      <option value="">Select</option>
      <? foreach($hfarecatnames as $key => $hfarecat){ ?>
      <option value="<?=$key?>"><?=$hfarecat;?></option>
      <? }?>
	</select>
    <td id="hdiv"></td>
	</td>
