...
if($_SERVER['REQUEST_METHOD']=="POST"){
	//if(!empty($_POST['forgot_password'])){
		//echo "asdasd";
		$yp=query("select * from ".$tablename." where cust_email='".$_POST['email']."' ");
		$yp_cnt=num_rows($yp);
		...
		if($yp_cnt!=0) { 
			...
			$yp_fg_ins_rand_txt=query("update ".$tablename." set cust_fg_password='".$random_text."',cust_fg_date='".$now_time."' where cust_email='".$_POST['email']."' ");
			...
			<table width='55%' border='0' align='center' cellspacing='0' cellpadding='0' class='borblue'>
				 <tr>
					...
					<a href='"."' target='_blank'><img src='"."images/svr-travels.jpg' border='0'/></a></td>
				  </tr>
				<tr>
				...
				<tr>
					<td>
					  ...
					  <tr>
						...
						<a href='"."reset-password.php?rid=".$random_text."'>"."reset-password.php?rid=".$random_text."</a></td>
					  </tr>
								</table>
							</td>
						</tr>
