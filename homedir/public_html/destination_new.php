...
if(!empty($_GET['sid']))
{
 	$nqur = query("select cat_name, subcat_name, subcat_meta_title, subcat_meta_keywords, subcat_meta_description, subsubcat_name, subcat_ref_no, subcat_banner_image from svr_categories as cat
...
$meta_title =$nav['subcat_meta_title'];
$meta_keywords =trim($nav['subcat_meta_keywords']);
$meta_description =trim($nav['subcat_meta_description']);

$designFILE = "design/destination_new.php";
