...
$result = query("select fc_id, fc_type, fc_locations, fc_name, fc_orderby, fc_status, fc_dateadded, cat_id, cat_name, group_concat(tloc_name order by tloc_orderby) as to_locations, concat(veh.vp_name, ' ', pax.vp_name, ' PAX') as vehicle from svr_fare_category as fc 
