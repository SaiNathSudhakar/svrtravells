...
if(!empty($_GET['t_status'])){
	...
	query("update svr_gallery set gal_status=".$status." where gal_id='".$_GET['sid']."'");
	header("location:manage_gallery.php");
}

$page_query = query("select gal_id from svr_testimonials");
...
$page_query = query("select gal_id from svr_gallery");
$total=num_rows($page_query);

$result = query("select * from svr_gallery order by gal_id desc limit $start,$len");
...
if(!empty($_GET['del'])){
	...
	query("delete from svr_gallery where gal_id='".$_GET['del']."'");
	header("location:manage_gallery.php");
}
?>
