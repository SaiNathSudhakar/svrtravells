...
if((isset($_SESSION['tm_type'])) && ($_SESSION['tm_type']=='admin' || ($_SESSION['tm_type']=='subadmin' && in_array('log',$_SESSION['tm_priv']) ) ) ){}else{header("location:welcome.php");}
$cond=""; $dw_cond=""; $emp=""; $emp_name=''; $emp_st=''; $reports_ft='';

$page_query = query("select login_id from tm_logindetails");
$total=num_rows($page_query);
$len=15; $start=0;
$link="logdetails.php?a=a";
...
$qur=query("select * from `tm_logindetails` where 1 ".$cond." order by login_id desc limit $start,$len");
$cnt=num_rows($qur);
?>
