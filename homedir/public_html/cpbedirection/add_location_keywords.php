...
if($_SERVER['REQUEST_METHOD']=="POST")
{
	...
	{
		query("update `svr_to_locations` set `tloc_meta_title`='".addslashes($_POST['meta_title'])."',`tloc_meta_description`='".addslashes($_POST['meta_description'])."',`tloc_meta_keywords`='".addslashes($_POST['meta_keywords'])."' where tloc_id='".$_GET['meta_id']."'");
		$uri=(!empty($_GET['start']))? "start=".$_GET['start']."&":'';
		header("location:manage_location_keywords.php?".$uri."msg=up");
	}
}
if(!empty($_GET['meta_id']))
{
