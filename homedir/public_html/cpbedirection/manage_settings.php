...
if(!empty($_GET['del'])){
	query("delete from svr_settings where sett_id='".$_GET['del']."'");
    ...
    <td valign="top" bgcolor="#FFFFFF"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
		  ...
		  <?php
			...
			query("update svr_settings set sett_status=".$status." where sett_id='".$_GET['sid']."'");
			header("location:manage_settings.php");
			}
			
		   $result = query("select * from svr_settings order by sett_id desc");
