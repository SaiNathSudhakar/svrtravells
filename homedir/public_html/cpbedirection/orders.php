    ...
    <td valign="top" bgcolor="#FFFFFF"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<tr>
		    ...
		    <tr>
		      <td><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="table">
                    <tr>
					  ...
					  <? if(isset($_SESSION['cb_search'])){ ?>
                          <img src="images/refresh.png" onclick="javascript:window.location='orders.php?src=reset'" style="cursor:pointer;" height="24" width="24" value="Reset" title="Reset"/>   
                        <? } ?></td>
                    </tr>
                </table></td>
		      </tr>
		  ...
		  <tr class="<?=($sno%2==0)?"tablerow2":"tablerow1";?>">
			...
			<td width="3%" align="center"><a href="javascript:;" onClick="popupwindow('view_orders.php?t_id=<?=$fetch['ord_id'];?>', 'Title', '750', '550')"><img src="images/view.gif" alt="View" title="View" width="16" height="16" /></a></td>
