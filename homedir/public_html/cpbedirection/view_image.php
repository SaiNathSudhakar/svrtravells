...
$qur=query("select tloc_ref_no, tloc_image from `svr_to_locations` where tloc_id='".$_GET['img_id']."'");
$row=fetch_array($qur);
?>
<style type="text/css">
<!--
...
<table width="100%" border="0" align="center" cellpadding="6" cellspacing="0">
  ...
  <tr>
    <td align="center"><table border="0" cellpadding="5" cellspacing="1" bgcolor="#ECE9D8">
      <tr>
        <td bgcolor="#FFFFFF"><img src="<?='uploads/destination_locations/'.$row['tloc_ref_no'].'/'.$row['tloc_image'];?>" /></td>
      </tr>
    </table>
    </td>
  </tr>
