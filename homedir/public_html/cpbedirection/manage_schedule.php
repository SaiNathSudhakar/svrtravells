          ...
          <td><table width="95%" align="center" border="0" cellspacing="0" cellpadding="6">
              ...
              <tr>
                <td><table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="table">
					...
					query("update svr_tour_schedule set sch_status=".$status." where sch_id='".$_GET['sch_id']."'");
					...
					<?
					$result = query("select * from svr_tour_schedule where tloc_id_fk=".$qry_arr['tloc_id']);
