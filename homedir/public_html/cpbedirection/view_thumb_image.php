...
$qur=query("select subcat_ref_no, subcat_thumb_image from `svr_subcategories` where subcat_id='".$_GET['vid']."'");
...
<table width="100%" border="0" align="center" cellpadding="6" cellspacing="0">
  ...
  <tr>
    <td align="center"><table border="0" cellpadding="5" cellspacing="1" bgcolor="#ECE9D8">
      <tr>
        <td bgcolor="#FFFFFF"><img src="<?='uploads/tour_packages/'.$row['subcat_ref_no'].'/'.$row['subcat_thumb_image'];?>" /></td>
      </tr>
    </table>
    </td>
  </tr>
