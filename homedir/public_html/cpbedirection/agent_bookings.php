		    ...
		    <tr>
		      <td><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="table">
                    <tr>
					  ...
					  <? if($_SESSION['cb_search'] != '' || $_SESSION['cb_agent'] != ''){ ?>
                          <img src="images/reset.png" onclick="javascript:window.location='agent_bookings.php?src=reset'" align="absmiddle" style="cursor:pointer;" value="Reset" title="Reset"/>   
                        <? }?></td>
                    </tr>
                </table></td>
		      </tr>
