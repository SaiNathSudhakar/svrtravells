...
if(empty($img_err_msg)&& !empty($_POST['title'])){
	...
	{
		$up=query("update svr_gallery set gal_title='".$name_replace."',gal_url='".$place_replace."',gal_upload='".$file_upload."' where gal_id='".$_GET['img_id']."'");
		header("location:manage_gallery.php");
	}else{
		query("insert into svr_gallery(
...
$edit = "Add";
if(!empty($_GET['img_id'])){
	$row = query("select * from svr_gallery where gal_id='".$_GET['img_id']."'");
