...
$page_query = query("select pkg_id from svr_packages");
$total=num_rows($page_query);
$len=30; $start=0;
$link="manage_packages.php?a=a";
if(!empty($_GET['start'])) { $start=$_GET['start']; } 

$result = query("select pkg_id, pkg_status, pkg_date, pkg_seats_available, tloc_name, floc_name, tloc_code, cat_name from svr_packages as pkg
